...
urlpatterns = [
 ...
 path("ordens/", views.OrdemListView.as_view(), name="ordem-list"), path("ordens/nova/", views.OrdemCreateView.as_view(), name="ordem-create"), path("ordens/<int:pk>/", views.OrdemDetailView.as_view(), name="ordem-detail"), path("ordens/<int:pk>/editar/", views.OrdemUpdateView.as_view(), name="ordem-update"), path("ordens/<int:pk>/excluir/", views.OrdemDeleteView.as_view(), name="ordem-delete"), path("ordens/<int:pk>/iniciar/", views.IniciarOSView.as_view(), name="ordem-iniciar"), path("ordens/<int:pk>/puxar/", views.PuxarOSView.as_view(), name="ordem-puxar"), path("ordens/<int:pk>/finalizar/", views.FinalizarOSView.as_view(), name="ordem-finalizar"), path("ordens/<int:pk>/confirmar/", views.ConfirmarOSView.as_view(), name="ordem-confirmar"),
    path("ordens/<int:pk>/recibo/", views.ReciboPixView.as_view(), name="ordem-recibo"),
    path("ler-erro/", views.ler_erro),
    path("ordens/<int:pk>/gerar-pix/", views.GerarPixOSView.as_view(), name="ordem-gerar-pix"),
    path("ordens/<int:pk>/checar-pix/<int:payment_id>/", views.ChecarPagamentoPixView.as_view(), name="ordem-checar-pix"),
 ...
 path("orcamentos/", views.OrcamentoListView.as_view(), name="orcamento-list"), path("orcamentos/novo/", views.OrcamentoCreateView.as_view(), name="orcamento-create"), path("orcamentos/<int:pk>/editar/", views.OrcamentoUpdateView.as_view(), name="orcamento-update"), path("orcamentos/<int:pk>/imprimir/", views.OrcamentoPrintView.as_view(), name="orcamento-print"), path("orcamentos/<int:pk>/gerar-os/", views.GerarOSFromOrcamentoView.as_view(), name="orcamento-geraros"),
 path("financeiro/", views.FinanceiroView.as_view(), name="financeiro"), path("financeiro/novo/", views.LancamentoCreateView.as_view(), name="lancamento-create"), path("financeiro/combustivel/", views.CombustivelCreateView.as_view(), name="lancar-combustivel"), path("financeiro/adiantamento/", views.AdiantamentoCreateView.as_view(), name="lancar-adiantamento"), path("relatorios/", views.RelatorioView.as_view(), name="relatorios"),
