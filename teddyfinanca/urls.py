...
urlpatterns = [
    ...
    path('venda_unica/<int:id>/receber/', views.receber_venda_unica, name='receber_venda_unica'),
    path('perfil/salvar/', views.salvar_perfil, name='salvar_perfil'),
    path('recibo/venda/<int:id>/', views.recibo_venda, name='recibo_venda'),
    path('recibo/venda_unica/<int:id>/', views.recibo_venda_unica, name='recibo_venda_unica'),
    ...
    path('game/reiniciar/<int:jogo_id>/', game_views.reiniciar_jogo, name='game_reiniciar'),
]
